...
EXECENV_LDLIBS += -ladvapi32 # RtlGenRandom()
EXECENV_LDLIBS += -lshlwapi  # MatchPathSpec()
EXECENV_LDLIBS += -lcfgmgr32 # device inspection
EXECENV_LDLIBS += -lsetupapi # device enumeration
EXECENV_LDLIBS += -lws2_32   # network services
...
EXECENV_LDFLAGS += -export-all-symbols
...
EXECENV_PROGRAM_SUFFIX := .exe
EXECENV_SHARED_SUFFIX := .dll

export EXECENV_PROGRAM_SUFFIX EXECENV_SHARED_SUFFIX
