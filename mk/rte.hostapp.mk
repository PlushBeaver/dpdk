...
_INSTALL += $(RTE_OUTPUT)/app/$(HOSTAPP)
_CLEAN = doclean
...
O_TO_EXE = $(HOSTCC) -o $@ $(OBJS-y) $(LDLIBS:-l%=%) \
	$(HOST_LDFLAGS) $(LDFLAGS_$(@)) $(EXTRA_HOST_LDFLAGS)
...
.PHONY: doclean
doclean:
	$(Q)rm -rf $(HOSTAPP) $(OBJS-all) $(DEPS-all) \
		$(DEPSTMP-all) $(CMDS-all) $(INSTALL-FILES-all) .$(HOSTAPP).cmd
